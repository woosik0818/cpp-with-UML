...
class InquiryPreVoteControl{
	...
	// Class : InquiryPreVoteControl
	// Description: InquiryPreVoteControl 클래스 선언. 
	// Created: 2017/5/28
	// Author: 임재형
	// Revsions : 
	//		When & Who :
...
public:
	...
	void getMenuIndex(InquiryPreVoteUI UserInterface, MainUserCollection* userCollect, MainVoteCollection* voteCollect, Timer* timer); // 인터페이스에 전달해주는 함수
};
